    ...
    <div className="bg-[#C83898]/10 mt-10 pb-20">
      <div className=" md:ml-20 pt-20">
        ...
        <section className="flex flex-col gap-4 place-center md:flex-row  justify-around mt-10">
          <div className="bg-white border-[#C83898] border-2  px-2 rounded-2xl w-[80%] mx-auto md:w-[100%] h-[200px] flex flex-col items-center ">
            <p className="text-[#4D4E4E] text-2xl mt-4">Full Tuiton</p>
            <h1 className="text-[#C83898] text-4xl">Ksh. 50,000</h1>
            <p className="text-[#4D4E4E] text-2xltext-sm mt-4">
          ...
          <div className="bg-white border-[#C83898] border-2  px-2 rounded-2xl w-[80%] mx-auto md:w-[100%] h-[200px] flex flex-col items-center ">
            ...
            <button className="text-[#C83898] border-2 border-[#C83898] px-4 rounded-3xl text-2xl mt-10">
              Contact us
            </button>
          </div>
        </section>
