...
const Testimonials = () => {
  ...
  return (
    ...
    >
      <div className=" pt-32 w-[75%]">
        <div className="bg-[#3778B8]">
          <h1 className="text-5xl text-white">Testimonials</h1>
          <p className="text-white">
            Dui viverra fermentum pulvinar penatibus at. Aliquet ut ultricies
            sem urna ut faucibus. Turpis fusce velit adipiscing odio consequat.
            Sed consequat nam vivamus quam ut viverra sed.
          </p>
        </div>
